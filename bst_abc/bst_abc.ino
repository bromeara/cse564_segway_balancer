...
double kp = 38, ki = 0.0, kd = 0.58;                   //These parameters need you to modify
...
const double PID_Original[6] = {38, 0.0, 0.58, 3.5, 0.1058, 0.0}; //Restoring default PID parameters
// PID Parameters of turn
double setp0 = 0, dpwm = 0, dl = 0; //Angular equilibrium point, PWM gap, dead zone, PWM1, PWM2
float value;
